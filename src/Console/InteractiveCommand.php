...
{
    protected $jobFormat = 'unserialize';
    ...
    protected function actionRefresh(SymfonyStyle $helper)
    {
        // no-op
    }
    ...
    protected function getJobChoices($status)
    {
        $choices = [];
        if (in_array($status, ['delayed', 'buried'])) {
            $choices[] = 'kick-one';
    ...
    protected function displayJob(array $jobData, array $jobStats, SymfonyStyle $helper)
    {
    ...
    protected function decodeJobBody($jobData)
    {
    ...
    protected function displayArrayJob(array $data, SymfonyStyle $output, $depth = 0)
    {
...
//
//    private function autocomplete(OutputInterface $output)
//    {
//        $inputStream = STDIN;
